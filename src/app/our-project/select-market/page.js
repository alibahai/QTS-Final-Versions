...
export default function Adore() {
  ...
  const images = [
    "/images/Select-Mart1.jpeg",
    "/images/Select-Mart2.jpeg",
    "/images/Select-Mart4.jpeg",
    "/images/Select-Mart3.jpeg",
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16 mt-16">
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">
          Gallery of Select Market
        </h2>
        <p className="text-gray-700 leading-relaxed">
        Select Market is a retail mart brand that offers everyday groceries, household essentials, and quick-grab snacks under one roof.
        It focuses on convenience—clear aisles, fast checkout, and practical pricing for routine shopping.
        Typical assortments include fresh produce, dairy, packaged foods, beverages, personal care, and basic home goods.
        Promotions center on weekly deals and bundle savings to attract budget-conscious shoppers.
        The brand positions itself as a friendly neighborhood stop where customers can complete most errands in a single visit.  
              </p>
            </div>
